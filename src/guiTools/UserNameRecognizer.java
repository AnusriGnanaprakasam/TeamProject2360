...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		if(input.length() <= 0) {
			...
			return "\n*** ERROR IN USERNAME *** The input is empty";
		}
		...
		while (running) {
			...
			case 0: 
				...
				//These conditions make sure that the first character of the string is Alphabetic
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
					...
					// too large.
					//This checks for the first character of the string
				}
