...
public class ViewNewAccount {
	...
	*/
	...
	// This alert is used when an improper username input is given, meaning that the username violates
	// any of the following conditions:
	//The first character of the username must be in A-Z or a-z
	//The username is  no less than 4 characters long
	//the username is no more than 16 characters long
