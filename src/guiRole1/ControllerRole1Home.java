...
public class ControllerRole1Home {
	 ...
	 * Uses ViewRole1Home's own stage and user so the forum receives the correct (non-null)
	 * user regardless of whether the Admin page has ever been visited.</p>
	 */
	protected static void openForum() {
		// Use Role1's own stage and user — NOT ViewAdminHome, which may be null
