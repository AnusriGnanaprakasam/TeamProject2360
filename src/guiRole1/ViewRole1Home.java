...
public class ViewRole1Home {
	...
	private ViewRole1Home() {
		...
		// GUI Area 2
		setupButtonUI(button_Forum, "Dialog", 16, 250, Pos.CENTER, 20, 430);
		// Use ControllerRole1Home.openForum() — NOT ControllerAdminHome — so that
		// ViewRole1Home.theStage and ViewRole1Home.theUser (never null here) are passed
		// to ViewForum instead of the potentially-null ViewAdminHome fields.
		button_Forum.setOnAction((_) -> { ControllerRole1Home.openForum(); });
		...
		theRootPane.getChildren().addAll(
			label_PageTitle, label_UserDetails, button_UpdateThisUser, line_Separator1, button_Forum,
