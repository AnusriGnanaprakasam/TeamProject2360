...
public class ControllerNewAccount {
	...
	*/
	 ...
	 * button.  This method checks the input fields to see that they are valid. (Riya) Particularly, I added a string builder to 
	...
	protected static void doCreateUser() {
		...
		// This function is used to check if username violates any of the following conditions
		//The first character of the username must be in A-Z or a-z
		//The username is not less than 4 characters long
		//the username is no greater than 16 characters long
		...
		if (errorMessage.length() > 0) {
			ViewNewAccount.alertUsernamePasswordError.setContentText(errorMessage.toString());
			...
			if (ViewNewAccount.text_Password1.getText().
				...
				applicationMain.HW2.activeHomePage = roleCode;
