...
public class ControllerFirstAdmin {
	...
	*/
	...
	protected static Database theDatabase = applicationMain.HW2.database;		
	...
	*/
	 ...
	 * database.  (Riya) It specifically checks if the username and password are valid before checking if the password match for
	 * easier user validation and input reading. If that is successful, 
	 * we proceed to the UserUpdate page.</p>
	 * 
	 */
	protected static void doSetupAdmin(Stage ps, int r) {
	    ...
	    if (errorMessage.length() > 0) {
	        ViewFirstAdmin.alertUsernamePasswordError.setContentText(errorMessage.toString());
